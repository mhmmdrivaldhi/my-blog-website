        ...
        <div class="p-12 bg-gray-300 shadow-sm card">
            ...
            <form class="space-y-4" wire:submit.prevent="handleEdit">
                <div class="flex flex-col gap-y-1">
                    <label for="title" class="font-bold tracking-widest text-black label">Title</label>
                ...
                <div class="flex-col gap-y-1">
                    <label for="" class="font-bold tracking-widest text-black label">Category</label>
                ...
                <div class="flex-col tracking-widest gap-y-1">
                ...
                <div class="flex flex-col gap-y-1">
                    <label for="" class="font-bold tracking-widest text-black label">Article Image</label>
                ...
                <div class="flex flex-col gap-y-1">
                    <label for="content" class="font-bold tracking-widest text-black label">Content</label>
                    <textarea cols="30" rows="10" class="w-full textarea" wire:model="content"></textarea>
                    @error('content')
                        <small class="text-red-500 error">{{ $message }}</small>
                     @enderror
                </div>
                <div class="flex tracking-wider gap-y-1 {{ $article->status == 'draft' ? 'hidden' : 'flex' }}">
                    <label for="is_trending" class="w-32 font-bold text-black label">Set Trending</label>
                    <select class="select select-primary" wire:model="is_trending">
