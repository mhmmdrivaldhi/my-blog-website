<div>
    <div class="container p-10 mx-auto">
        <div class="p-12 bg-gray-300 shadow-sm card">
            ...
            <form class="space-y-4" wire:submit.prevent="handleSubmit">
                <div class="flex flex-col gap-y-1">
                    <label for="title" class="font-bold text-black label">Title</label>
                    <input type="text" class="w-full input" wire:model="title">
                    @error('title')
                ...
                <div class="flex">
                    <button class="font-bold btn btn-outline btn-primary rounded-xl btn-block">Save</button>
                </div>
            </form>
        </div>
    </div>
