    ...
    <div class="grid grid-cols-2 min-h-[70vh] px-5 place-items-center">
        <div class="col-span-2 px-5 py-8 lg:col-span-1 lg:py-3 space-y-7">
            ...
            <div class="flex flex-col items-center justify-center lg:items-start lg:justify-start gap-y-2">
                <h1 class="text-2xl font-bold md:text-3xl lg:text-4xl lg:w-[35rem] md:w-[35rem] w-[18rem] text-center lg:text-left tracking-wider">Find your lifestyle, unlock your passion, live healthy, grow stronger, and thrive with technology.</h1>
            </div>
        </div>
